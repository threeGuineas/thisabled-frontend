...
const styles = {
  ...
  // 맨 위 검색창
  searchBar: ['flex items-center gap-2 mx-5 mb-4 px-4 py-3 rounded-2xl', colors.bg.gray04].join(' '),
  ...
  requestBanner: ['flex items-center justify-between mx-5 mb-3 px-4 py-3.5 rounded-2xl', colors.bg.gray04, 'active:opacity-70'].join(' '),
  ...
  // 채팅 목록 — 리스트형(divider) 레이아웃
  chatList: 'flex flex-col',
  chatItem: ['flex items-center gap-3 px-5 py-3 w-full text-left border-b', colors.border.gray03].join(' '),
  ...
  unreadBadge: [colors.bg.yellow, 'min-w-[20px] h-5 px-1.5 rounded-full flex items-center justify-center text-black', typography.xs, typography.bold].join(' '),
  ...
  retryButton: [colors.bg.gray04, 'rounded-xl px-5 py-3 text-black', typography.sm, typography.regular].join(' '),
  ...
  acceptButton: [colors.bg.yellow, 'flex-1 rounded-full px-4 py-3 text-center text-black disabled:opacity-40', typography.xs, typography.bold].join(' '),
