...
const styles = {
  ...
  otherText: [typography.sm, typography.regular, 'text-black leading-relaxed whitespace-pre-wrap break-words'].join(' '),
  ...
  myReadText: [typography.xs, typography.bold, 'text-[#FFD60A]'].join(' '),
  myTime: [typography.xs, typography.regular, 'text-[#B3B3BD]'].join(' '),
  myBubble: [colors.bg.yellow, 'rounded-2xl rounded-br-sm px-3.5 py-2.5 shadow-sm'].join(' '),
  myText: [typography.sm, typography.regular, 'text-black leading-relaxed whitespace-pre-wrap break-words'].join(' '),
  ...
  sendButtonActive: [colors.bg.yellow, 'w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0'].join(' '),
  sendIcon: 'w-4 h-4',
