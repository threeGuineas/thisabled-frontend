...
export default function BlindMyScreen({ onTabChange, onLoggedOut }: Props) {
        ...
        <div className={styles.editAvatarRow}>
          <div className={styles.editAvatarWrapper}>
            {avatarSrc ? (
              ...
              <div className={`${styles.editAvatar} bg-[#FFD60A] flex items-center justify-center text-black font-bold text-2xl`}>
