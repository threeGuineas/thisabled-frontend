...
import styles from './HearingPostDetailScreen.styles'
import {
  getComments,
  createComment,
  type Comment,
...
export default function HearingPostDetailScreen({ post, category, me, onBack, onToggleLike, onCommentCountChange, onMessage }: Props) {
          ...
          <div className={styles.mediaList}>
            {post.media.map((media) =>
              media.media_type === 'video' ? (
                <VideoCaptionPlayer key={media.id} postId={post.id} media={media} />
              ) : (
                <img
                  key={media.id}
