...
const styles = {
  ...
  modeButtonActive: [
    'w-full flex items-center justify-between pl-[13px] pr-4 py-4',
    'border-l-[3px] border-[#4C7DFF]', colors.bg.blue01,
    'transition-colors',
  ].join(' '),
  ...
  // 자막 설정 (CAPTION)
  captionSection: 'px-5 mt-8',
  captionSectionTitle: ['text-[#666666]', typography.sm, typography.bold, 'px-1'].join(' '),
  captionCard: 'mt-2 bg-white rounded-3xl flex flex-col shadow-sm overflow-hidden',

  captionRow: 'w-full flex items-center justify-between gap-3 px-4 py-4',
  captionRowTitle: ['text-black', typography.sm, typography.extrabold].join(' '),
  captionDivider: ['h-px mx-4', colors.bg.gray03].join(' '),

  captionPreviewSection: 'px-4 pt-1 pb-4 flex flex-col gap-3',
  captionPreviewLabel: ['text-[#9898A8]', typography.xs, typography.semibold].join(' '),
  captionPreviewBox: 'w-full rounded-2xl bg-[#1C1C1E] flex items-center justify-center px-4 py-8',
  captionPreviewTextSmall: [typography.xs, typography.bold, 'text-center leading-relaxed'].join(' '),
  captionPreviewTextMedium: [typography.base, typography.bold, 'text-center leading-relaxed'].join(' '),
  captionPreviewTextLarge: [typography.xl, typography.bold, 'text-center leading-relaxed'].join(' '),
  captionPreviewColorBlack: 'text-black',
  captionPreviewColorWhite: 'text-white',
  captionPreviewColorYellow: 'text-[#FFD60A]',

  captionSizeRow: [colors.bg.gray04, 'flex rounded-2xl p-1 gap-1'].join(' '),
  captionSizeButtonActive: [colors.bg.blue, 'flex-1 rounded-xl py-2.5 text-center text-white', typography.sm, typography.bold].join(' '),
  captionSizeButtonInactive: ['flex-1 rounded-xl py-2.5 text-center text-[#8E8E93]', typography.sm, typography.medium].join(' '),

  captionColorRow: 'flex items-center gap-4',
  captionColorButton: 'flex flex-col items-center gap-1.5',
  captionColorSwatch: 'w-9 h-9 rounded-full border-2 border-transparent',
  captionColorSwatchActive: ['w-9 h-9 rounded-full border-2', colors.border.blue].join(' '),
  captionColorSwatchBlack: 'bg-black',
  captionColorSwatchWhite: 'bg-white border border-[#EBEBEF]',
  captionColorSwatchYellow: 'bg-[#FFD60A]',
  captionColorLabel: ['text-[#666666]', typography.xs, typography.medium].join(' '),
  captionColorLabelActive: ['text-black', typography.xs, typography.bold].join(' '),

  // 알림 (NOTIFICATION)
  notifSection: 'px-5 mt-8',
  notifSectionTitle: ['text-[#666666]', typography.sm, typography.bold, 'px-1'].join(' '),
  notifCard: 'mt-2 bg-white rounded-3xl flex flex-col shadow-sm overflow-hidden',
  notifDivider: ['h-px mx-4', colors.bg.gray03].join(' '),

  notifRow: 'w-full flex items-center gap-3 px-4 py-4',
  notifIconWrapper: [colors.bg.blue01, 'w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0'].join(' '),
  notifIcon: 'w-5 h-5',
  notifTextGroup: 'flex-1 flex flex-col gap-0.5 text-left',
  notifTitle: ['text-black', typography.sm, typography.extrabold].join(' '),
  notifDesc: ['text-[#9898A8]', typography.xs, typography.regular].join(' '),
  ...
  etcIconWrapper: [colors.bg.blue01, 'w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0'].join(' '),
  etcIcon: 'w-5 h-5',
  ...
  sheetConfirmButton: [
    'w-full rounded-2xl py-4', colors.bg.blue,
    'flex items-center justify-center mt-2',
    'active:opacity-80 transition-opacity',
  ].join(' '),
  sheetConfirmText: ['text-white', typography.base, typography.bold].join(' '),
  ...
  editInput: [
    ...
    'placeholder:text-[#9898A8] outline-none focus:bg-white focus:border-[#4C7DFF]',
  ].join(' '),
  editTextarea: [
    colors.bg.gray04,
  ...
  editSaveButtonText: ['text-white', typography.base, typography.bold].join(' '),
  ...
  categoryButtonOpen: [
    colors.bg.blue01, 'border', colors.border.blue, 'border-b-0',
  ...
  categoryCount: [
    colors.bg.blue, 'text-white min-w-[18px] h-[18px] px-1 rounded-full',
  ...
  tagPanel: [
    ...
    'border border-t-0', colors.border.blue, colors.bg.blue01,
    'px-4 py-3.5',
  ].join(' '),
  ...
  tagChipSelected: [colors.bg.blue, 'px-3 py-2 rounded-full text-white', typography.xs, typography.semibold].join(' '),
  ...
  withdrawOptionSelected: [colors.bg.blue01, 'border', colors.border.blue, 'w-full flex items-start gap-3 rounded-2xl px-4 py-4 text-left active:opacity-80 transition-opacity'].join(' '),
  withdrawRadio: 'w-4 h-4 rounded-full border border-[#D6D6DC] mt-0.5 flex-shrink-0',
  withdrawRadioSelected: ['w-4 h-4 rounded-full border-[5px] mt-0.5 flex-shrink-0', colors.border.blue].join(' '),
